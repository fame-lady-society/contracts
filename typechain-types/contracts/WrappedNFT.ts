...
export interface WrappedNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "EMIT_METADATA_ROLE"
...
export interface WrappedNFT extends BaseContract {
  connect(runner?: ContractRunner | null): WrappedNFT;
  waitForDeployment(): Promise<this>;

  interface: WrappedNFTInterface;
