...
export interface BulkMinterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "lastMintedTokenId",
    values?: undefined
  ): string;
...
export interface BulkMinter extends BaseContract {
  connect(runner?: ContractRunner | null): BulkMinter;
  waitForDeployment(): Promise<this>;

  interface: BulkMinterInterface;
  ...
  lastMintedTokenId: TypedContractMethod<[], [bigint], "view">;

  mint: TypedContractMethod<[count: BigNumberish], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "lastMintedTokenId"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
